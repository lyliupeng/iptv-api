...
```bash
https://raw.githubusercontent.com/lyliupeng/iptv-api/master/output/result.m3u
```

```bash
https://raw.githubusercontent.com/lyliupeng/iptv-api/master/output/result.txt
```

或

```bash
https://cdn.jsdelivr.net/gh/lyliupeng/iptv-api@master/output/result.m3u
```

```bash
https://cdn.jsdelivr.net/gh/lyliupeng/iptv-api@master/output/result.txt
```

- 数据源：

```bash
https://raw.githubusercontent.com/lyliupeng/iptv-api/master/source.json
```

或

```bash
https://cdn.jsdelivr.net/gh/lyliupeng/iptv-api@master/source.json
```
